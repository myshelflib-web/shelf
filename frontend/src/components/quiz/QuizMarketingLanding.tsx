        ...
        <section className="relative px-4 sm:px-6 py-16 sm:py-24 max-w-3xl mx-auto text-center overflow-hidden">
          ...
          <RevealOnScroll>
            ...
            <p className="text-base sm:text-lg text-[var(--text-secondary)] leading-relaxed max-w-2xl mx-auto">
              Sit timed MCQs, written answers, and photos of working — scoped to
              a document, an upload plus syllabus, or a PYQ-style exam bank.
              Choose a proctored fullscreen sitting or practice mode, then open
              the analysis board when you are done.
            </p>
