...
export const POST_HERO_VISUAL: Record<string, BlogVisualId> = {
  ...
  "study-ai-planner-quiz-actions": "study-ai",
  "study-ai-stop-queue-diagrams": "study-ai",
  "exam-style-quiz-from-your-notes": "study-ai",
  ...
  "share-study-streak-cards": "dashboard",
  ...
  "youtube-lectures-in-your-library": "split-view",
  "pwa-offline-study-app": "pwa",
  "paraphrase-and-library-originality": "study-ai",
  "research-doc-writing-suite": "notebook",
...
export const POST_SECTION_VISUALS: Record<string, BlogVisualId[]> = {
  ...
  "study-ai-planner-quiz-actions": ["study-ai", "calendar", "dashboard"],
  "study-ai-stop-queue-diagrams": ["study-ai", "library", "calendar"],
  "exam-style-quiz-from-your-notes": ["study-ai", "library", "dashboard"],
  ...
  "youtube-lectures-in-your-library": ["split-view", "notebook", "library"],
