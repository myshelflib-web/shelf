...
export const POST_HERO_VISUAL: Record<string, BlogVisualId> = {
  ...
  "store-notes-pdfs-ask-llm": "study-ai",
  "shelf-vs-notebooklm": "study-ai",
  "shelf-vs-chatpdf": "study-ai",
  "shelf-vs-notion-ai": "study-ai",
  "shelf-vs-obsidian": "notebook",
  "all-in-one-study-workspace": "library",
  "teacher-tool-prepare-tests": "study-ai",
  "student-study-tool-ask-llm": "study-ai",
  "shelf-vs-alternatives-features-pricing": "premium",
  "best-notebooklm-alternatives": "study-ai",
  "chat-with-pdf-ai": "study-ai",
  "ai-pdf-summarizer-students": "study-ai",
  "ai-flashcards-quizzes-from-pdf": "study-ai",
  "best-study-apps-for-students": "dashboard",
  "free-ai-study-tools": "premium",
  "ai-tutor-from-notes": "study-ai",
  "remnote-quizlet-anki-alternatives": "study-ai",
  "goodnotes-notability-alternative": "notebook",
};
...
export const POST_SECTION_VISUALS: Record<string, BlogVisualId[]> = {
  ...
  "store-notes-pdfs-ask-llm": ["library", "study-ai", "upload"],
  "shelf-vs-notebooklm": ["study-ai", "library", "reader"],
  "shelf-vs-chatpdf": ["study-ai", "reader", "library"],
  "shelf-vs-notion-ai": ["study-ai", "notebook", "library"],
  "shelf-vs-obsidian": ["notebook", "library", "study-ai"],
  "all-in-one-study-workspace": ["library", "study-ai", "dashboard"],
  "teacher-tool-prepare-tests": ["study-ai", "calendar", "library"],
  "student-study-tool-ask-llm": ["study-ai", "library", "reader"],
  ...
  "best-notebooklm-alternatives": ["study-ai", "library", "premium"],
  "chat-with-pdf-ai": ["study-ai", "reader", "library"],
  "ai-pdf-summarizer-students": ["study-ai", "reader", "upload"],
  "ai-flashcards-quizzes-from-pdf": ["study-ai", "library", "dashboard"],
  "best-study-apps-for-students": ["dashboard", "library", "study-ai"],
  "free-ai-study-tools": ["premium", "study-ai", "library"],
  "ai-tutor-from-notes": ["study-ai", "reader", "library"],
  "remnote-quizlet-anki-alternatives": ["study-ai", "notebook", "library"],
  "goodnotes-notability-alternative": ["notebook", "reader", "study-ai"],
};
