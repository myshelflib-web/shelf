...
export type MarketingFeatureGroupId =
  | "library"
  | "reader"
  | "study-ai"
  | "practice";
...
export type MarketingFeatureGroup = {
  id: MarketingFeatureGroupId;
  label: string;
  blurb: string;
  features: MarketingFeature[];
};

/** Grouped for the animated landing showcase (all copy still on-page for SEO). */
export const MARKETING_FEATURE_GROUPS: MarketingFeatureGroup[] = [
  {
    id: "library",
    label: "Library & Docs",
    blurb: "Upload, organize, and write beside your sources.",
    features: [
      {
        icon: FileUp,
  ...
  },
  {
    id: "reader",
    label: "Reader",
    blurb: "Tabs, split view, highlights, and lectures in one workspace.",
    features: [
      {
        icon: Columns2,
  ...
  },
  {
    id: "study-ai",
    label: "Study AI",
    blurb: "Ask, summarize, and map ideas from your own material.",
    features: [
      {
  ...
  },
  {
    id: "practice",
    label: "Quiz & plan",
    blurb: "Practice papers and a calendar linked to your pages.",
    features: [
      {
        icon: ListChecks,
...
/** Flat list for about page / crawlable summaries. */
export const MARKETING_FEATURES: MarketingFeature[] =
  MARKETING_FEATURE_GROUPS.flatMap((group) => group.features);
