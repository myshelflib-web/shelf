/**
 * Map provider / transport errors to short copy safe for the UI.
 * Mirror of backend/src/utils/studyAiUserError.ts — keep patterns in sync.
 */
...
export function toUserStudyAiError(err: unknown): string {
