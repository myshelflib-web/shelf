...
| `/learn/...` | Curriculum (admin content), not personal collections. Browse (`/learn`, subject, topic) uses the Library explorer chrome; opening a collection shows that study goal’s resources plus other tracks. Articles open the reader workspace. |
