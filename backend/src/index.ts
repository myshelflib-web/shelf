...
import citationSourcesRoutes from "./routes/citationSources.js";
import pageRevisionsRoutes from "./routes/pageRevisions.js";
import pageCommentsRoutes from "./routes/pageComments.js";
import docImportHtmlRoutes from "./routes/docImportHtml.js";
...
import studyWritingRoutes from "./routes/studyWriting.js";
import copyleaksWebhookRoutes from "./routes/copyleaksWebhook.js";
...
app.use("/api/my-content", citationSourcesRoutes);
app.use("/api/my-content", pageRevisionsRoutes);
app.use("/api/my-content", pageCommentsRoutes);
app.use("/api/my-content", docImportHtmlRoutes);
...
app.use("/api/study", studyWritingRoutes);
app.use("/api", copyleaksWebhookRoutes);
