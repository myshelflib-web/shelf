...
export const DEFAULT_INGEST_SOURCES: IngestSourceSeed[] = [
  {
    ...
    kind: "RSS",
    feedUrl: "https://pib.gov.in/Rss.aspx",
  ...
  },
  {
    ...
    kind: "RSS",
    feedUrl: "https://prsindia.org/rss-feed",
    studyGoals: ["UPSC", "STATE_PCS"],
    license: "GOVERNMENT_PRESS",
    cadence: "DAILY",
    maxItemsPerRun: 15,
  ...
  },
  {
    ...
    feedUrl: "https://www.upsc.gov.in/examinations/active-exams",
    studyGoals: ["UPSC"],
  ...
  },
  {
    ...
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://www.indiabudget.gov.in/documents.php",
  ...
  },
  {
    ...
    slug: "gate-official",
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://gate2025.iisc.ac.in/",
    studyGoals: ["GATE"],
    license: "LINK_ONLY",
    cadence: "MONTHLY",
    maxItemsPerRun: 5,
