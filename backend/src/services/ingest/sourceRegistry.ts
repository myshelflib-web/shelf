...
export const DEFAULT_INGEST_SOURCES: IngestSourceSeed[] = [
  ...
  {
    name: "DD News — English feed",
    slug: "ddnews-english",
    kind: "RSS",
    feedUrl: "https://ddnews.gov.in/en/feed/",
    studyGoals: ["UPSC", "STATE_PCS"],
    license: "GOVERNMENT_PRESS",
    cadence: "HOURLY",
    maxItemsPerRun: 15,
    promoteToSubjectSlug: "current-affairs",
    promoteToTopicSlug: "daily-digest",
    config: { tags: ["ddnews", "government"] },
  },
  {
    name: "PIB — Hindi releases",
    slug: "pib-hindi",
    kind: "RSS",
    feedUrl: "https://pib.gov.in/RssMain.aspx?ModId=6&Lang=2&Regid=3",
    studyGoals: ["UPSC", "STATE_PCS"],
    license: "GOVERNMENT_PRESS",
    cadence: "DAILY",
    maxItemsPerRun: 15,
    promoteToSubjectSlug: "current-affairs",
    promoteToTopicSlug: "daily-digest",
    config: { tags: ["pib", "hindi"] },
  },
  {
    name: "MoEFCC — Environment ministry",
    slug: "moefcc-portal",
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://moef.gov.in/",
    studyGoals: ["UPSC", "STATE_PCS"],
    license: "LINK_ONLY",
    cadence: "WEEKLY",
    maxItemsPerRun: 5,
    promoteToSubjectSlug: "environment-ecology",
    promoteToTopicSlug: "official-updates",
    config: { tags: ["environment", "ecology"] },
  },
  {
    name: "Supreme Court of India",
    slug: "sci-portal",
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://main.sci.gov.in/",
    studyGoals: ["JUDICIARY", "UPSC"],
    license: "LINK_ONLY",
    cadence: "WEEKLY",
    maxItemsPerRun: 5,
    promoteToSubjectSlug: "law-official",
    promoteToTopicSlug: "statutes",
    config: { tags: ["judiciary", "supreme-court"] },
  },
  {
    name: "NPTEL — Engineering courses",
    slug: "nptel-portal",
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://nptel.ac.in/",
    studyGoals: ["GATE"],
    license: "LINK_ONLY",
    cadence: "MONTHLY",
    maxItemsPerRun: 5,
    promoteToSubjectSlug: "gate-official",
    promoteToTopicSlug: "exam-portal",
    config: { tags: ["nptel", "gate"] },
  },
  {
    name: "GST — Official portal",
    slug: "gst-portal",
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://www.gst.gov.in/",
    studyGoals: ["CA"],
    license: "LINK_ONLY",
    cadence: "WEEKLY",
    maxItemsPerRun: 5,
    promoteToSubjectSlug: "ca-official",
    promoteToTopicSlug: "institute-portals",
    config: { tags: ["gst", "ca"] },
  },
  {
    name: "NMC — Medical education",
    slug: "nmc-portal",
    kind: "OFFICIAL_PAGE_WATCH",
    feedUrl: "https://www.nmc.org.in/",
    studyGoals: ["NEET_PG"],
    license: "LINK_ONLY",
    cadence: "MONTHLY",
    maxItemsPerRun: 5,
    promoteToSubjectSlug: "medicine-official",
    promoteToTopicSlug: "regulatory",
    config: { tags: ["nmc", "medicine"] },
  },
];
